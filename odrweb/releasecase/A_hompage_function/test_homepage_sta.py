...
class HomepageNoLogin(unittest.TestCase):
    ...
    def test_10(self):
        ...
        nologinpage.change_windows()
        res = nologinpage.verification_head_service_online_chat()   # 验证方法为验证进入智能机器人
        self.assertEqual(True,res)
    ...
    def test_16(self):
        ...
        res = nologinpage.verification_head_resource_organization_info(ogr_name_11,ogr_name_12)
        self.assertEqual(True, res)
    ...
    def test_17(self):
        ...
        res = nologinpage.verification_head_resource_organization_search(ogr_name_21,ogr_name_22)
        self.assertEqual(True, res)
    ...
    def test_18(self):
        ...
        res = nologinpage.verification_head_resource_serpersonal_info( per_name_11, per_name_12)
        self.assertEqual(True, res)
    ...
    def test_19(self):
        ...
        res = nologinpage.verification_head_resource_serpersonal_search(per_name_21, per_name_22)
        self.assertEqual(True, res)
    ...
    def test_48(self):
        ...
        nologinpage.get_url()
        nologinpage.mid_law()
        res = nologinpage.verification_head_help_self_consult()   # 验证方法为进入法律咨询校验方法
        self.assertEqual(True,res)
    ...
    def test_53(self):
        ...
        res = nologinpage.verification_head_help_common_apply()   # 验证方法为进入常见问题申请调解
        self.assertEqual(True,res)
    ...
    def test_55(self):
        ...
        res = nologinpage.verification_head_help_common_online()   # 验证方法为常见问题在线评估
        self.assertEqual(True,res)
    ...
    def test_56(self):
        ...
        res = nologinpage.verification_head_help_common_result()   # 验证方法为常见问题查看结果
        self.assertEqual(True,res)
    ...
    def test_59(self):
        ...
        res = nologinpage.verification_head_service_online_chat()  # 验证方法为进入智能咨询页面
        self.assertEqual(True,res)
