...
from odrweb.page.simple_disputepage import SimpleDisputePage
...
class SimpleJfInputSave(unittest.TestCase):
    ...
    def test_04(self):
        ...
        simple_jf_info = {"applicant": u"段志勇",
                          ...
                          "jf_desc": u"简易案件登记-申请人-代理人-被申请人-代理人",
                          "jf_appeal": u"类型是否正确",
                          "jf_action": u"验证类型",
                          "jf_time": u"三天"
                          }
